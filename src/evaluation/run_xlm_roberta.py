...
if __name__ == "__main__":
    config_instance = DenseHyperParams(
        query_encoder_path="sentence-transformers/xlm-r-distilroberta-base-paraphrase-v1",
        document_encoder_path="sentence-transformers/xlm-r-distilroberta-base-paraphrase-v1",
        batch_size=32,
