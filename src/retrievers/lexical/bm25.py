...
from src.retrievers.lexical.ElasticSearch import ElasticSearch
...
class BM25Search:
    ...
    Args:
        BaseRetriver (_type_): _description_
    """

    def __init__(
        self,
        index_name: str,
        hostname: str = "https://localhost:9200",
        cert_path: str = "./http_cert",
        elastic_password: str = "password",
        ...
        print("elastic_password", elastic_password, cert_path)
        self.config = {
            "hostname": hostname,
